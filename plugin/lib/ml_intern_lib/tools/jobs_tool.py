...
from ml_intern_lib.tools.types import ToolResult

logger = logging.getLogger(__name__)
from ml_intern_lib.tools.utilities import (
    format_job_details,
    format_jobs_table,
...
async def hf_jobs_handler(
    ...
    try:
        ...
        if sandbox and script:
            from ml_intern_lib.tools.sandbox_tool import resolve_sandbox_script
